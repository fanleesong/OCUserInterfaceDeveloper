...
@property(nonatomic,retain)NSMutableArray *typeShow;
...
- (void)viewDidLoad
{
    ...
    self.title =@"图书类型";
    self.typeShow = [BookTypeDao findAllBooksTypeInfo];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    BookType *type = [self.typeShow objectAtIndex:indexPath.row];
